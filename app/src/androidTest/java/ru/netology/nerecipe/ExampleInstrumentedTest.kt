...
class ExampleInstrumentedTest {
    ...
    fun createAndEditRecipes(){
        ...
        val step11 = RecipeStage(0L, id1,"Step 1 of recipe 1")
        val step12 = RecipeStage(0L, id1,"Step 2 of recipe 1")
        val step13 = RecipeStage(0L, id1,"Step 3 of recipe 1")

        val step21 = RecipeStage(0L, id2,"Step 1 of recipe 2")
        val step22 = RecipeStage(0L, id2,"Step 2 of recipe 2")

        val step31 = RecipeStage(0L, id3,"Step 1 of recipe 3")

        val step41 = RecipeStage(0L, id4,"Step 1 of recipe 4")
        val step42 = RecipeStage(0L, id4,"Step 2 of recipe 4")
        val step43 = RecipeStage(0L, id4,"Step 3 of recipe 4")
        val step44 = RecipeStage(0L, id4,"Step 4 of recipe 4")
